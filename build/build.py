...
I.append(dict(id="i1", num="I", titre="Nommer le manche",
 ...
 steps=[
  ...
  ("morceau",45,11,"On s'en sert tout de suite","Tu annonces un accord, il pose le barré au bon endroit. Fa, Sol, Si♭, Ré. Forme de mi puis forme de la. C'est là qu'il comprend à quoi ça sert.",
 ...
 fc=['<h5>La gamme de do</h5><pre class="tab">DO   RÉ   MI  FA   SOL  LA   SI  DO\n'
     ...
     '<b>2.</b> Les barrés : je dis « sol », tu poses la forme de mi case 3.<br>'
...
I.append(dict(id="i2", num="II", titre="La pentatonique sort de sa boîte",
 ...
 fc=['<h5>Position V — celle que tu connais</h5><pre class="tab">e|-------------------5--8--|\nB|----------------5--8-----|\n'
     'G|-----------5--7----------|\nD|--------5--7-------------|\nA|-----5--7----------------|\nE|--5--8-------------------|</pre>'
     '<p class="cap">La mineur. Fondamentale : case 5 de la corde de mi grave.</p>',
...
I.append(dict(id="i3", num="III", titre="La gamme blues",
 ...
 fc=['<h5>La gamme blues, position V</h5><pre class="tab">e|--------------------------5--8--|\nB|-----------------------5--8-----|\n'
     'G|-----------------5--7--8--------|\nD|--------------5--7--------------|\nA|-----5--6--7--------------------|\nE|--5--8--------------------------|</pre>'
     '<p class="cap">Les deux notes en gras : case 6 de la corde de la, case 8 de la corde de sol. C\'est le mi♭, la blue note.</p>',
...
I.append(dict(id="i5", num="V", titre="Le blues en accords de sixte",
 ...
 steps=[
  ...
  ("jeu",39,9,"Les deux autres degrés","Même principe sur ré et sur mi, mais le bloc se joue sur les trois cordes aiguës. Ré case 7, do case 5, mi case 9.",[]),
 ...
 fc=['<h5>Le premier degré (la)</h5><pre class="tab">   A6       G6\ne|-----------------|\nB|--7--------5-----|\n'
     'G|--6--------4-----|\nD|--7--------5-----|\nA|--0--0-----0--0--|\nE|-----------------|</pre>'
...
I.append(dict(id="i7", num="VII", titre="Hey Joe, ou la grille qui monte",
 objectif="Cinq accords : <em>do, sol, ré, la, mi</em>. Chacun est la quinte du précédent. Une fois qu'il voit ça, il ne l'oublie plus et il la retrouve dans la moitié de ce qu'il écoute.",
 steps=[
  ("cadre",0,4,"Accordage, turnaround de la semaine","",[]),
  ("jeu",4,10,"La grille","Do, sol, ré, la, mi. Une mesure chacun, deux sur le mi, et ça recommence. Il l'écrit dans son carnet avant de la jouer.",
  ...
  ("jeu",22,14,"Les enchaînements","Le passage difficile est ré vers la, puis la vers mi : trois accords ouverts d'affilée qui se ressemblent. Isole-le.",
  ...
  ("jeu",36,10,"La version barrée","La même grille en formes mobiles, do case 8 et sol case 3 sur la corde de mi grave. C'est là que la séance I paye.",[]),
  ("morceau",46,10,"Le morceau","La grille en boucle, tempo lent. Tu joues la mélodie ou tu chantes, il tient. Puis l'inverse.",[]),
  ("cadre",56,4,"Le mi de la fin","Annonce la séance VIII : le dernier accord de la boucle n'est pas un mi ordinaire.",[]),
 ],
 ...
 fc=['<h5>La grille</h5><div class="grille"><span>C</span><span>G</span><span>D</span><span>A</span><span>E</span><span>E</span></div>'
     ...
     '<h5>En barrés</h5><pre class="tab">do   forme de la, case 3\nsol  forme de mi, case 3\nré   forme de la, case 5\nla   forme de mi, case 5\nmi   forme de mi, case 12</pre>',
     ...
     '<b>2.</b> Isole ré → la → mi. C\'est le passage qui traîne.<br>'
...
I.append(dict(id="i8", num="VIII", titre="L'accord de Hendrix",
 objectif="Le mi septième dièse neuf. Un accord qui contient sa tierce majeure et sa tierce mineure en même temps — ce qui devrait sonner faux, et qui sonne comme le blues électrique tout entier.",
 steps=[
  ...
  ("morceau",47,9,"La grille du solo","Mi septième dièse neuf, puis sol, puis la. Trois accords qui tournent, et c'est là-dessus qu'on improvisera à la séance X.",[]),
  ("cadre",56,4,"Devoirs","",[]),
 ],
 pied=["<b>Si l'écartement ne passe pas :</b> il existe une version à trois cordes, sans la fondamentale, que le bassiste ou la corde grave assurent. Mais fais l'effort deux semaines avant de plier.",
       "<b>Sur folk :</b> l'accord existe mais il sonne dur en acoustique. Garde-le pour l'électrique, et remplace-le par un mi septième ordinaire si l'élève n'a qu'une folk.",
 ...
 fc=['<h5>La forme</h5><div class="accords"><span class="accord" data-chord="E7s9"></span></div>'
     ...
     '<h5>Il est mobile</h5><pre class="tab">case 5   →  ré 7♯9\ncase 7   →  mi 7♯9\ncase 10  →  sol 7♯9</pre>'
...
I.append(dict(id="i10", num="X", titre="Improviser sur les changements",
 ...
 steps=[
  ...
  ("morceau",40,12,"Sur la grille du solo","Mi 7 ♯9, sol, la. Plus court, plus dur, plus gratifiant. La gamme blues de la séance III y trouve tout son sens.",[]),
 ...
 pied=["<b>Techniquement, ce qui manque après ces dix heures :</b> les deux positions de pentatonique restantes, les accords de septième mineurs et majeurs, le jeu en doubles-cordes, et l'arpège de l'accord plutôt que la gamme.",
...
RECAP_I = [
 ...
 ("VIII","<b>Mi 7 ♯9</b>, l'accord de Hendrix","Court et sec, jamais tenu","La grille E7♯9 – G – A","Quatre cordes qui sonnent, deux étouffées"),
  ...
  <div class="paire">
    ...
    <div class="p-col">
      ...
      <ul>
        ...
        <li>L'électrique devient utile. Sur folk tout reste jouable, sauf le mi 7 ♯9 qui sonne dur.</li>
      </ul>
    </div>
  </div>
  ...
  <div class="paire">
    ...
    <div class="p-col">
      ...
      <ul>
        ...
        <li>La transcription de « Purple Haze » : accord de mi 7 ♯9, slides, quarts de ton, bends, harmoniques pincées, et la grille du solo notée à la main en bas de page. Elle donne les séances VIII et IX.</li>
...
def page(fichier, volet, titre, sous_titre, bandeau, intro, seances, recap, ids, desc):
    nav = ['<nav class="nav" aria-label="Séances"><div class="wrap">'
           '<span class="navlabel">Sommaire</span><a href="#avant">Avant</a>']
...
n2 = page('intermediaire.html', 'intermediaire', 'Les dix heures suivantes',
          ...
          "Dix séances d'une heure pour un guitariste qui a passé le stade débutant : notes du manche, positions de gamme, blues en sixtes, mi 7 dièse 9 et improvisation.")
